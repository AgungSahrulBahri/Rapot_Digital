    ...
    var _columnsWaterfallsExamples = function() {
        ...
        if (columns_stacked_element) {
            ...
            columns_stacked.setOption({
                ...
                xAxis: [{
                    type: 'category',
                    data: ['Januari 2018', 'February 2018', 'Maret 2018', 'April 2018', 'Mei 2018', 'Juni 2018', 'Juli 2018'],
                    axisLabel: {
                        color: '#333'
                    },
                    axisLine: {
